...
func wobble_sprite(offset: float, phase_shift : float) -> void: #setting phase shift to 1 seems to solve issue for some reason
	var time = Time.get_ticks_msec() / 1000.0 
	var wobble_percent = sin(time * angular_follow_speed/2 + phase_shift) 
